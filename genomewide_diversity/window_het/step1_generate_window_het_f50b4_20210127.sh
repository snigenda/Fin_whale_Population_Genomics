...
#$ -wd <homedir>
#$ -o <homedir>/reports/window_het/step1_generate_window_het_f50b4_20210127.out.txt
#$ -e <homedir>/reports/window_het/step1_generate_window_het_f50b4_20210127.err.txt
#$ -m abe
