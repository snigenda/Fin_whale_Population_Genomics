...
# Execution: Rscript --vanilla step2_generate_plot_object_f50b4_20210824.R
...
indir = './data/window_het/raw_data/f50b4_window_het_20210128/'
...
hetfiles = paste0('./data/window_het/raw_data/f50b4_window_het_20210128/JointCalls_f50b4_08_B_VariantFiltration_', sprintf('%02d', seq(01,96)), '_het_1000000win_1000000step.txt')
...
# remove the regions with too much missing or the region at the end of a scaffold that are way too short compared with 1mb window (should be 2258)
...
# output data --------
write.csv(allhet, file = paste0(outdir, 'winHet_1Mbwin_1Mbstep_20Per_f50b4_', today, '.csv'))
saveRDS(plotdt, file = paste0(outdir, 'winHet_1Mbwin_1Mbstep_20Per_f50b4_plotdt_', today, '.rds'))
write.csv(plotdt, file = paste0(outdir, 'winHet_1Mbwin_1Mbstep_20Per_f50b4_plotdt_', today, '.csv'))
