...
# def variables --------
outdir = "<homedir>/ROH/rohBcftools/"
today = format(Sys.Date(), "%Y%m%d")

# load data --------
ind50 = read.csv(file = "<homedir>/scripts/config/popmap_all50.csv", stringsAsFactors = F, header = 1)
...
for (ii in 1:nrow(ind50)) {
    ...
    pop=ind50[ii,'PopId']
    filename = paste0("<homedir2>/finwhale/analyses_results/structure_diversity/roh/rohBcftools/",
