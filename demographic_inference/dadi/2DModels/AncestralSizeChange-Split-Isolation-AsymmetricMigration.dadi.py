...
modelName="2D.Ancestral.Isolation"
...
upper_bound = [10, 20, 10, 10,5,10,30,700] # 20 as upper bound on mig rec by dadi
p0 = [0.113,1.54,0.3,1.1,0.0071,0.01,2.5,110] # initial parameters
