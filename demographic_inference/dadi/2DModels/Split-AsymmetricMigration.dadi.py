...
modelName="2D.ConstantSize.ASIMigration"
...
upper_bound = [10, 5, 5, 300, 10] # 20 as upper bound on mig rec by dadi
p0 = [1.31,0.0071,2.3,112,0.225] # initial parameters; changing starting mu parameter because won't get permuted 
