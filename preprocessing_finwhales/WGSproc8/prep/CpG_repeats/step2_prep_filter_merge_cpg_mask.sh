...
# Final length
MASK="<homedir2>/finwhale/cetacean_genomes/minke_whale_genome/GCF_000493695.1_BalAcu1.0/CpG_repeats.bed"

awk -F'\t' '{SUM += $3-$2} END {print SUM}' ${MASK}
# 768,518,931

MASK2="<homedir2>/finwhale/cetacean_genomes/minke_whale_genome/GCF_000493695.1_BalAcu1.0/CpG_repeats_all.bed"
