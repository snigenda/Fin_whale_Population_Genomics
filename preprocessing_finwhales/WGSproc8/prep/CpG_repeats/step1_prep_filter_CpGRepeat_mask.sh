...
cd <homedir2>/finwhale/cetacean_genomes/minke_whale_genome
DIR=/u/project/rwayne/jarobins/utils/programs/repeatmask
FASTA=<homedir2>/finwhale/cetacean_genomes/minke_whale_genome/GCF_000493695.1_BalAcu1.0/GCF_000493695.1_BalAcu1.0_genomic.fasta
...
cd <homedir2>/finwhale/cetacean_genomes/minke_whale_genome/GCF_000493695.1_BalAcu1.0/
...
SCRIPTDIR=<homedir2>/finwhale/scripts/WGSproc8/prep/CpG_repeats
WORK=<homedir2>/finwhale/cetacean_genomes/minke_whale_genome/GCF_000493695.1_BalAcu1.0/ucsc/
