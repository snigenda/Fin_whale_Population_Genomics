...
#$ -o <homedir>/reports/get_ALLregions_CDS/snpEff_LOF_step3_extract_ALLregions_vcf_20201218.out.txt
#$ -e <homedir>/reports/get_ALLregions_CDS/snpEff_LOF_step3_extract_ALLregions_vcf_20201218.err.txt
#$ -m abe
