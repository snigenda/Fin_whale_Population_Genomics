...
#$ -wd <homedir>
#$ -o <homedir>/reports/get_ALLregions_CDS/gtf_CDS_step2_extract_ALLregions_CDS_f50b4_vcf_20210127.out.txt
#$ -e <homedir>/reports/get_ALLregions_CDS/gtf_CDS_step2_extract_ALLregions_CDS_f50b4_vcf_20210127.err.txt
#$ -m abe
...
LOGDIR=${OUTDIR}/logs
SCRATCHDIR="<scratchdir>/finwhale/analyses/get_ALLregions_CDS/${DATASET}/${REF}"
...
# The bed file used
BEDFILE="<homedir>/get_ALLregions_CDS/all50/Minke/bedfiles/Minke.CDSstartstop.Coords.FromGTF.0Based.sorted_merged.bed"
# The reference fasta
