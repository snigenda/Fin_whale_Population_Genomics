...
#$ -wd <homedir>
#$ -o <homedir>/reports/get_ALLregions_CDS/gtf_CDS_step2_extract_ALLregions_CDS_vcf_20201218.out.txt
#$ -e <homedir>/reports/get_ALLregions_CDS/gtf_CDS_step2_extract_ALLregions_CDS_vcf_20201218.err.txt
#$ -m abe
