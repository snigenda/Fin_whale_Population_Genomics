...
#$ -o <homedir>/reports/snpEff_impact/step1_snpEff_impact_extract_filteredvcf_bed_20210129.out.txt
#$ -e <homedir>/reports/snpEff_impact/step1_snpEff_impact_extract_filteredvcf_bed_20210129.err.txt
#$ -m abe
