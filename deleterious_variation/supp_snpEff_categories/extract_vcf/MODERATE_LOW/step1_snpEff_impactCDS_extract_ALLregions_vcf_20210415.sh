...
#$ -wd <homedir>
#$ -o <homedir>/reports/get_ALLregions_CDS/snpEff_impactCDS_step1_extract_ALLregions_vcf_20210415.out.txt
#$ -e <homedir>/reports/get_ALLregions_CDS/snpEff_impactCDS_step1_extract_ALLregions_vcf_20210415.err.txt
#$ -m abe
