...
sink(file = './data/slim/derived_data/logs/summary_output_20210919.log')
...
finalmodels = c('finwhale_2pop_ancestralChange_040121', 'finwhale_2pop_ancestralChange_noMig_040121',
                'finwhale_ENP_OLDchr_071421','finwhale_ENP_recovery_OLDchr_071421')
...
enpfiles = paste0(indir, 'finwhale_ENP_OLDchr_071421/rep', 1:25, '/slimout_finwhale_ENP_OLDchr_071421_rep',1:25,'.txt')
enprecfiles = paste0(indir, 'finwhale_ENP_recovery_OLDchr_071421/rep', 1:25, '/slimout_finwhale_ENP_recovery_OLDchr_071421_rep',1:25,'.txt')
...
# output files --------
# raw files
saveRDS(migdt, file = paste0(outdir, finalmodels[1], '_allgen_20210919.rds'))
saveRDS(nomigdt, file = paste0(outdir, finalmodels[2], '_allgen_20210919.rds'))
saveRDS(enpdt, file = paste0(outdir, finalmodels[3], '_allgen_20210919.rds'))
saveRDS(enprecdt, file = paste0(outdir, finalmodels[4], '_allgen_20210919.rds'))

# last generations
saveRDS(last2popdt, file = paste0(outdir, 'finwhale_2pop_ancestralChange_040121_lastgen_20210919.rds'))
saveRDS(lastenpdt, file = paste0(outdir, 'finwhale_ENP_OLDchr_071421_lastgen_20210919.rds'))

# plotting data frame
saveRDS(plot2popdt, file = paste0(outdir, 'slim_plotdt_2pop_ancestralChange_20210919.rds'))
saveRDS(plotenpdt, file = paste0(outdir, 'slim_plotdt_ENP_20210919.rds'))
