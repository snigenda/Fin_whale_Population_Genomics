...
# Example: Rscript --vanilla  '<homedir>/finwhale/analyses/PopStructure/f50b4/Minke' 'JointCalls_f50b4_filterpass_bialleic_all_LDPruned_mafNA.gds' 'JointCalls_f50b4_filterpass_bialleic_all_LDPruned_mafNA'
