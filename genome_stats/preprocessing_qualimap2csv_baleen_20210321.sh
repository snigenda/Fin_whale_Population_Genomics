...
mydate=$(date "+%Y%m%d")
outdir="<homedir>/Summary_stats/f50b4/Minke/qualimap_${mydate}"
mkdir -p $outdir
...
summaryfile=<homedir>/baleen_genomes/preprocessing/${sample}/Minke/${sample}_A_Aligned_stats/genome_results.txt
