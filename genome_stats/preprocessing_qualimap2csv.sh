...
mydate=$(date "+%Y%m%d")
outdir="<homedir>/Summary_stats/all50/Minke/qualimap_${mydate}"
mkdir -p $outdir
...
summaryfile=<homedir2>/finwhale/preprocessing/${sample}/Minke/${sample}_A_Aligned_stats/genome_results.txt
