...
# Date: Mon Jan  9 21:40:09 2023
write.csv(forplot[[1]][,c('SampleId', 'GenomeHet')], file = '~/Lab/fin_whale/FinWhale_PopGenomics_2021/source_data/Fig2a-finwhalehet.csv')
write.csv(forplot[[2]], file = '~/Lab/fin_whale/FinWhale_PopGenomics_2021/source_data/Fig2a-roh.csv')
write.csv(othergenomehet[,1:5], file = '~/Lab/fin_whale/FinWhale_PopGenomics_2021/source_data/Fig2a-otherhet.csv')
write.csv(winhetdt, file = '~/Lab/fin_whale/FinWhale_PopGenomics_2021/source_data/Fig2b-winhet.csv')
